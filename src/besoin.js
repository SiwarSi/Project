...
import { View, ScrollView, Text, StyleSheet, TouchableHighlight, TouchableOpacity, Image, TouchableWithoutFeedbackBase, TextInput, Button } from 'react-native';
      ...
      <View>
         <ScrollView>
            ...
            <View style={{ alignItems: 'center' }}>
               <Image source={require('../images/besoin.png')} style={{
            ...
            <View style={{
               ...
               <View style={{ flexDirection: 'column', }}>
                  <Text style={{ fontSize: 15, color: '#3F3D56', fontWeight: 'bold', marginLeft: 10 }}>Sensation de besoin</Text>
