...
const AjouterMédecin = ({ navigation }) => {
    return (
        ...
        <View style={[styles.container, {
            ...
            <View style={{ flex: 8, backgroundColor: "#FFFFFF", margin: 15, borderRadius: 20, borderColor: '#3F3D56' }} >
                <View style={{ margin: 20 }}>
                    ...
                    <TextInput placeholder="Entrer votre Email" style={{ borderWidth: 2, borderColor: '#E3807B', margin: 10, marginBottom: 10, padding: 8, backgroundColor: '#FFFFFF', borderRadius: 20, shadowRadius: 5 }} />
                    ...
                    <Button
                        onPress={() => navigation.navigate('AjouterAdmin')}
                        title="Enregistrer"
                        color="#5B779F"
                        borderRadius="40"
