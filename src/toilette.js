...
import ValueSliderT from './valueSlider2';
import ValueSliderN from './ValueSlider3';
      ...
      <View>
         <ScrollView>
            ...
            <View style={{ alignItems: 'center' }}>
               ...
               <Text style={{ fontSize: 15, color: '#3F3D56', marginBottom: 0 }}> </Text>
            </View>
            <View style={{
               alignSelf: 'center',
               ...
               <View style={{ flexDirection: 'column', }}>
                  <Text style={{ fontSize: 15, color: '#3F3D56', fontWeight: 'bold', marginLeft: 10 }}>Volume d'urine</Text>
               ...
               <View style={{ flexDirection: 'column', }}>
                  <Text style={{ fontSize: 15, color: '#3F3D56', fontWeight: 'bold', marginLeft: 10 }}>Accident?</Text>
                  <TextInput style={{ borderColor: '#3F3D56', borderRadius: 20, borderWidth: 3, width: 0.8 * width, height: height * 0.09, marginRight: 10 }}></TextInput>
               </View>
               <View style={{ flexDirection: 'column', }}>
                  <Text style={{ fontSize: 15, color: '#3F3D56', fontWeight: 'bold', marginLeft: 10 }}>Symptomes</Text>
                  <TextInput style={{ borderColor: '#3F3D56', borderRadius: 20, borderWidth: 3, width: 0.8 * width, height: height * 0.09, marginRight: 10 }}></TextInput>
               </View>
            <ValueSliderT/>
            <ValueSliderN/>
